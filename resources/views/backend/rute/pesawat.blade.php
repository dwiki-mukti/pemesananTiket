    ...
    <div class="row mb-2">
      <div class="col-sm-6">
        <ol class="breadcrumb "> <!-- float-sm-right -->
          <li class="breadcrumb-item active">Perjalanan Pesawat</li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
        ...
        <div class="card">
          <div class="card-header">
            <div class="d-inline-block">
              <h3>Data Perjalanan Pesawat</h3>
              <a href="{{route('riwayatPerjalanan',['key'=>'pesawat'])}}" style="text-decoration: underline !important;"><i style="margin-left: 2px; font-size: 13px" class="fas fa-history"></i> Riwayat</a>
            </div>
            ...
            <div class="card-tools">
              ...
              <a href="{{ route('data_rute.create', ['tipe'=> 'pesawat']) }}" class="btn btn-outline-success"><i class="fas fa-plus"></i> Add Data </a>
            </div>
          </div>
          <div class="card-body">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="{{ route('data_rute.edit', ['data_rute'=> $r->id]) }}" class="text-warning">edit</a> |
